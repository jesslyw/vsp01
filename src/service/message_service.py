...
class MessageService:
    ...
    def send_create_message_request(self, sol_ip, port, star_uuid, origin, sender, subject, message, msg_id=None):
        """
    ...
    def send_delete_message_request(self, sol_ip, port, star_uuid, msg_id, ):
        """
    ...
    def send_list_messages_request(self, sol_ip, port, star_uuid, scope="active", view="id"):
        """
    ...
    def send_get_message_request(self, sol_ip, port, msg_id, star_uuid):
        """
