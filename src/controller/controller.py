...
def initialize_flask_endpoints(app, peer_service, sol_service):
    ...
    def accept_sol_shutdown(req_com_uuid):
        ...
        # global_logger.info(f"Peer Received req_com_uuid: {req_com_uuid}, req_star_uuid: {req_star_uuid}")
        # global_logger.info(f"peer_service.peer.com_uuid: {peer_service.peer.com_uuid}, req_star_uuid: {peer_service.peer.sol_connection.star_uuid}")
        if (
